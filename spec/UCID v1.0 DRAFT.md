...
* Relationships between 2 or more UCIDs may be expressed to indicate where parent-child associations, aliases, derivatives, or format translations. This allows for UCID "graphs" to be established that promote discovery ad interoperability. 
